...
export default function DailyRoutine2() {
  ...
  const [mansahar,setMansahar] = useState('');
  const [tel, setTel] = useState('');
  const [sukameva,setSukameva] = useState('');
  const [fade,setFade] = useState('');
  const [thandapadatha,setThandapadartha] = useState('');
  const [palebhajya,setPalebhajya] = useState('');
  const [fadbhajya,setFadbhajya] = useState('');
  const [dhanya,setDhanya] = useState('');
  const [iter,setIter] = useState('');
  const [jalsevan,setJalsevan] = useState('');
  const [malpravrutti,setMalpravrutti] = useState('');
  const [mutrapravruti,setMutrapravruti] = useState('');
  const [swedpravrutti,setSwedpravrutti] = useState('');
  const [rajpravrutti,setRajpravrutti] = useState('');
  const submitButton = () =>{
    Axios.post("http://localhost:3001/dailyroutine2",{
      mansahar : mansahar,
      tel : tel,
      sukameva : sukameva,
      fade : fade,
      thandapadatha : thandapadatha,
      palebhajya : palebhajya,
      fadbhajya : fadbhajya,
      dhanya : dhanya,
      iter : iter
    }) 
          ...
          <form>
            <div className="grid xl:grid-cols-2 xl:gap-6 mt-2">
              ...
              <div className="relative  mb-2 w-full group">
                <Select isMulti={true} options={मांसाहार} onChange ={(e) => {setMansahar(e)}} />
            ...
            <div className="grid xl:grid-cols-2 xl:gap-6">
              ...
              <div className="relative  mb-2 w-full group">
                <Select isMulti={true} options={तेल} onChange ={(e) => {setTel(e)}}/>
              </div>
            </div>
            <div className="grid xl:grid-cols-2 xl:gap-6">
              <div className="relative mt-2 w-full group text-md">
              ...
              <div className="relative  mb-2 w-full group">
                {" "}
                <Select isMulti={true} options={सुकामेवा} onChange ={(e) => {setSukameva(e)}}/>
              </div>
            </div>
            <div className="grid xl:grid-cols-2 xl:gap-6">
            ...
            <div className="grid xl:grid-cols-2 xl:gap-6">
              ...
              <div className="relative  mb-2 w-full group">
                <Select isMulti={true} options={थंडपदार्थ} onChange ={(e) => {setThandapadartha(e)}}/>
              </div>
            </div>
            <div className="grid xl:grid-cols-2 xl:gap-6">
              ...
              <div className="relative  mb-2 w-full group">
                <input
                  ...
                  className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                  placeholder=" "
                  onChange ={(e) => {setPalebhajya(e.target.value)}}
                />
              </div>
            </div>
            <div className="grid xl:grid-cols-2 xl:gap-6">
              ...
              <div className="relative  mb-2 w-full group">
                <input
                  ...
                  className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                  placeholder=" "
                  onChange ={(e) => {setFadbhajya(e.target.value)}}
                />
              </div>
            </div>
