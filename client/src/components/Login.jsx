    ...
    <div className="flex justify-center items-center h-screen space-x-40">
      <form>
        ...
        {window.location.href.includes("doctor") ? (
          <Link to={"/doctor"}>
            <div class="mt-6">
              <button class="w-full inline-flex items-center justify-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold capitalize text-white hover:bg-red-700 active:bg-red-700 focus:outline-none focus:border-red-700 focus:ring focus:ring-red-200 disabled:opacity-25 transition" onClick={login}>
