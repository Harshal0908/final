...
export default function EditData({ header, medicineData, operation }) {
  ...
  const [dealer_number,setDealer_number] = useState('');
                  ...
                  <form>
                    ...
                    <div class="grid xl:grid-cols-2 xl:gap-6">
                      ...
                      <div class="relative z-0 mb-6 w-full group">
                        <input
                          ...
                          name={header[4]}
                          id={header[4]}
                          onChange ={(e)=>{setDealer_number(e.target.value)}}
                          class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                          placeholder=" "
                          value={dealer_number}
                          required
                    ...
                    <div class="grid xl:grid-cols-2 xl:gap-6">
                      <div class="relative z-0 mb-6 w-full group">
                        <button
                          type="submit"
                          class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={submitButton}>
                          Submit
                        </button>
                      </div>
